...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/grapeape.git

**All changes should be based from the `vNext` branch.**

Push to your fork and [submit a pull request](https://github.com/michaeljolley/grapeape/compare/) against the `vNext` branch.
